...
while True:
    ...
    if face is not None:
        ...
        mask, pos, color, eyeImage, thresholdEye = m.EyeTracking(frame, grayFrame, RightEyePoint) # maske ve gözbebeði

        #mask, pos, color = m.EyeTracking(frame, grayFrame, RightEyePoint) # maske ve gözün gözlemlenmediði hali
        maskleft, leftPos, leftColor , eyeImageLeft, thresholdEyeLeft= m.EyeTracking(frame, grayFrame, LeftEyePoint) # maske ve gözbebeði
